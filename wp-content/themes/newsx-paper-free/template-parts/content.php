			...
			<div class="xpost-text p-3">
				...
				<div class="entry-content">
					...
					if (is_single()) {
						the_content(
							sprintf(
								wp_kses(
									...
									__('Continue reading<span class="screen-reader-text"> "%s"</span>', 'newsx-paper-free'),
									array(
										'span' => array(
											'class' => array(),
										),
						...
						wp_link_pages(
							array(
								'before' => '<div class="page-links">' . esc_html__('Pages:', 'newsx-paper-free'),
								'after'  => '</div>',
							)
						);
					} else {
						the_excerpt();
						newsx_paper_free_readmore_text();
					}
