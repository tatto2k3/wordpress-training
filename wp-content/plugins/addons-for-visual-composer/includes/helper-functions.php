...
function lvca_get_template_part(  $template_name, $args = null, $return = false  ) {
    $template_file = $template_name . '.php';
    $default_folder = LVCA_PLUGIN_DIR . 'templates/';
    // Allow the user to place the templates in a different folder than the default addons-for-beaver-builder/ folder
    $theme_folder = apply_filters( 'lvca_addons_templates_folder', LVCA_PLUGIN_SLUG );
